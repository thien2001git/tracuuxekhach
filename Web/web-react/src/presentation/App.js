                        ...
                        <div style={{
                            ...
                            <input type={"text"}
                                   style={{
                                       ...
                                       height: "90%",
                                       margin: "0px 10px"
                                   }} onChange={this.handleInput.bind(this)} onClick={this.handleInput.bind(this)} value={this.state.textSearch}/>
                            <img src={MicIcon} title={"MicIcon"} alt={"MicIcon"}/>
                        </div>

                        <div style={{display: this.state.isHideResult}}>
                            <SearchHistory icon={ClockHistory} title={"okok"} onDataUpdate={handleChildData}/>
                        </div>
                    </div>
